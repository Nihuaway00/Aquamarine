...
3. Использует данные для оптимизации работы системы.
...
3. Если пользователь пытается скачать удаленный файл, он видит сообщение: **"Срок хранения файла истек. Пожалуйста, повторите операцию"**.
