...
3. ❗️Изучить развертывание (настройку арендованного сервера, балансировщика нагрузки и CI/CD)
...
#### Работа с PDF
- объединить, разделить, удалить страницы, извлеч изображения, сжать
...
- ❗️Тестирование: Jest
### Дополнительно
- Модифицкация PDF файлов: Pdf-lib
- Работа с изображениями в PDF: Pdf.js
### Архитектура
